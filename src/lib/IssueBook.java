...
public class IssueBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Issue Book information");
    ...
    public void issue_book() {
        ...
        if (IssueBookDB.checkBook(book_name)) {

            int i = IssueBookDB.save(book_name, book_id, student_id, s_name, mobile);
            if (i > 0) {
                ...
                JOptionPane.showMessageDialog(IssueBook.this, "Sorry, unable to save!");
            }
        } else {
