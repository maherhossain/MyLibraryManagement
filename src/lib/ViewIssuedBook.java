...
public class ViewIssuedBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("View Issued Book details");
        setPreferredSize(new java.awt.Dimension(715, 520));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Name", "Author", "Issued To", "Issde Date", "Submition Date", "Status", "Submit Delay"
            }
        ) {
    ...
    public static void printDoc() {
        MessageFormat header = new MessageFormat(" Record Print ");
